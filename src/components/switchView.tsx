    ...
    >
      <div className="icons-container">
        ...
        <svg
          ...
          viewBox="0 0 13 13"
          fill="none"
          className={`grid-icon ${display === "list" ? "hidden" : "show"} ${
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className={`list-icon ${display === "list" ? "show" : "hidden"} ${
      ...
      <div
        //prettier-ignore
        className={`button ${display === "list" ? "" : "active"} ${darkMode ? "button-dark" : ""} ${color === 'blue' ? 'button-blue': color === 'red' ? 'button-red' : ''}`}
      ></div>
    </div>
  );
}
